                ...
                <div className='mb-4'>
                    <div className="mb-4 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            <div>
                                <label className="block text-sm font-medium">4. Date of Birth</label>
                                <input
                                    type="text"
                                    name="dateOfBirth"
                                    className="w-full common-input"
                        ...
                        <label className="block text-sm font-medium">5. Age at Time of Death</label>
                        <div className="flex flex-col md:flex-row gap-4">
                            {/* If 1 year or above */}
                            <div className="flex-1">
                            <label className="block text-sm font-medium">a. If 1 year or above</label>
                            ...
                            {/* If under 1 year */}
                            <div className="flex-1">
                            <label className="block text-sm font-medium">b. If under 1 year</label>
                            ...
                            {/* If under 24 hours */}
                            <div className="flex-1">
                            <label className="block text-sm font-medium">c. If under 24 hours</label>
                                <div className="flex flex-col space-y-2">
                                {/* Hours */}
                                <div className="relative w-full">
                                    <input
                    ...
                    <div className="mb-6 space-y-6">
                        ...
                        <div className="relative w-full">
                            ...
                            type="text"
                            name="residence_full"
                            placeholder="House No., St., Brgy, City/Mun., Province, Country"
                            className="common-input w-full"
                            value={[
                                deceased.residence_house,
                                deceased.residence_street,
                                deceased.residence_barangay,
                                deceased.residence_city,
                                deceased.residence_province,
                                deceased.residence_country,
                            ]
                    ...
                    <div className="mb-6 space-y-6">                        
                        ...
                        <div className="mb-8">
                            <label className="block text-base mb-2">12. Mother’s Name</label>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <input
                                        type="text"
                        ...
                        {/* Father’s Name */}
                        <div className="mb-8">
                            <label className="block text-base mb-2">13. Father’s Name</label>
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <input
                                        type="text"
...
<div className="mb-6 space-y-6">
  ...
  <div className="flex flex-col items-center">
    ...
    <div className=" mt-8">
        <label className="font-semibold">19a. Cause of Death</label>
    </div>
  <div>
  ...
  <div>
    ...
    />
                    ...
                    <div className="mb-6 space-y-6">
                        ...
                        <div className=" mt-8">
                            <label className="font-semibold">19b. Cause of Death (If the deceased is aged 8 days and over)</label>
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium">II. Other Significant Conditions</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block font-semibold">19c. Maternal Condition (if the deceased is female aged 15-49 years old)</label>
                            <input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div >
                        <label className="block text-sm font-medium mb-1">
                            b. Place of Occurrence (for external cause)
                        </label>
                        <input
                        ...
                        <label className="block text-sm font-medium">20. Autopsy</label>
                        <input
                            name="autopsy"
                            className="w-full common-input"
                        ...
                        {/* Attendant Type */}
                        <div className="md:col-span-2">
                        <label className="block text-sm font-medium mb-1">21a. Attended By</label>
                        <input
                            type="text"
                            name="attendant"
                            placeholder="Specify"
                        ...
                        {/* Attendant Duration */}
                        <div>
                        <label className="block text-sm font-medium">21b. From (mm/dd/yy)</label>
                        <input
                            type="text"
                            name="attendantFrom"
                            className="w-full common-input"
                    ...
                    <div className="mb-6 space-y-6">
                        <h2 className="text-lg text-center font-semibold">22. Certification of Death</h2>
                        {/* Certification Oath */}
                    ...
                    <div className="mb-6 space-y-6">
                        ...
                        {/* Disposal Type */}
                        <div>
                            <label className="block text-sm font-medium">23. Corpse Disposal  (Burial, Cremation, if others, specify)</label>
                            <input
                                name="disposalType"
                                className="w-full common-input"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium">24a. Burial/Cremation Permit Number</label>
                                <input
                                    type="text"
                                    name="permitNumber"
                                    className="w-full common-input"
                        ...
                        <div>
                            <label className="block text-sm font-medium">24b. Transfer Permit Number</label>
                            <input
                                type="text"
                                name="transferPermit"
                                className="w-full common-input"
                    ...
                    <div className="mb-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-md">26. Certification of Informant</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium mb-1">Signature</label>
                                    <SignaturePlaceholder />
                        ...
                        {/* Prepared By */}
                        <div className="space-y-4">
                            <h3 className="text-md">27. Prepared By</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium mb-1">Signature</label>
                                    <SignaturePlaceholder />
                    ...
                    <div className="mb-6 space-y-6">
                        {/* Received By */}
                        <div className="space-y-4">
                            <h3 className="text-md">28. Received By</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium mb-1">Signature</label>
                                    <SignaturePlaceholder />
                        ...
                        {/* Registered By */}
                        <div className="space-y-4">
                            <h3 className="text-md">29. Registered by the Civil Registrar</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium mb-1">Signature</label>
                                    <SignaturePlaceholder />
