...
export default function BirthCertifcateForm() {
  ...
  const handlePageChange = (direction) => {
    if (direction === 'next') {
      const response = BirthCertValidation.validateForm(
        ...
        <div className="mb-4">
            ...
            <div className="mb-4 text-left space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  />
                  {errors.province && (
                    <ErrorMessages errors={errors.province} />
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  <div>
                    ...
                    {errors.childFirstName && (
                      <ErrorMessages errors={errors.childFirstName} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.childMiddleName && (
                      <ErrorMessages errors={errors.childMiddleName} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.childLastName && (
                      <ErrorMessages errors={errors.childLastName} />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
                  ...
                  <select
                    name="sex"
                    className={`common-input w-full ${errors.sex ? 'input-error' : ''
                      }`}
                  ...
                  >
                    ...
                    <option
                      value={capitalizeFirst(BirthCertificate.SexTypes.MALE)}
                    >
                      {capitalizeFirst(BirthCertificate.SexTypes.MALE)}
                    </option>
                    <option
                      value={capitalizeFirst(BirthCertificate.SexTypes.FEMALE)}
                    >
                      {capitalizeFirst(BirthCertificate.SexTypes.FEMALE)}
                    </option>
                  </select>
                ...
                <div>
                  ...
                  <input
                    type="date"
                    name="dateOfBirth"
                    className={`common-input w-full ${errors.dateOfBirth ? 'input-error' : ''
                      }`}
                    value={formData.page1.dateOfBirth}
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.dateOfBirth && (
                    <ErrorMessages errors={errors.dateOfBirth} />
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  />
                  {errors.typeOfBirth && (
                    <ErrorMessages errors={errors.typeOfBirth} />
                  )}
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.multipleBirthOrder && (
                    <ErrorMessages errors={errors.multipleBirthOrder} />
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  />
                  {errors.birthOrder && (
                    <ErrorMessages errors={errors.birthOrder} />
                  )}
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  />
                  {errors.birthWeight && (
                    <ErrorMessages errors={errors.birthWeight} />
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 text-left space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  <div>
                    ...
                    />
                    {errors.maidenFirstName && (
                      <ErrorMessages errors={errors.maidenFirstName} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    />
                    {errors.maidenMiddleName && (
                      <ErrorMessages errors={errors.maidenMiddleName} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.maidenLastName && (
                      <ErrorMessages errors={errors.maidenLastName} />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  />
                  {errors.citizenship && (
                    <ErrorMessages errors={errors.citizenship} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  />
                  {errors.religion && (
                    <ErrorMessages errors={errors.religion} />
                  )}
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                />
                {errors.childrenBornAlive && (
                  <ErrorMessages errors={errors.childrenBornAlive} />
                )}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium">
                    ...
                    />
                    {errors.childrenStillLiving && (
                      <ErrorMessages errors={errors.childrenStillLiving} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium">
                    ...
                    />
                    {errors.childrenDeceased && (
                      <ErrorMessages errors={errors.childrenDeceased} />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  />
                  {errors.occupation && (
                    <ErrorMessages errors={errors.occupation} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  />
                  {errors.ageAtBirth && (
                    <ErrorMessages errors={errors.ageAtBirth} />
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    {errors.residenceHouse && (
                      <ErrorMessages errors={errors.residenceHouse} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.residenceCity && (
                      <ErrorMessages errors={errors.residenceCity} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.residenceProvince && (
                      <ErrorMessages errors={errors.residenceProvince} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.residenceCountry && (
                      <ErrorMessages errors={errors.residenceCountry} />
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  <div>
                    ...
                    {errors.fatherFirstName && (
                      <ErrorMessages errors={errors.fatherFirstName} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.fatherMiddleName && (
                      <ErrorMessages errors={errors.fatherMiddleName} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.fatherLastName && (
                      <ErrorMessages errors={errors.fatherLastName} />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.fatherCitizenship && (
                    <ErrorMessages errors={errors.fatherCitizenship} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  {errors.fatherReligion && (
                    <ErrorMessages errors={errors.fatherReligion} />
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  {errors.fatherOccupation && (
                    <ErrorMessages errors={errors.fatherOccupation} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.fatherAgeAtBirth && (
                    <ErrorMessages errors={errors.fatherAgeAtBirth} />
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    {errors.fatherResidenceStreet && (
                      <ErrorMessages errors={errors.fatherResidenceStreet} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    />
                    {errors.fatherResidenceCity && (
                      <ErrorMessages errors={errors.fatherResidenceCity} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    />
                    {errors.fatherResidenceProvince && (
                      <ErrorMessages errors={errors.fatherResidenceProvince} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    />
                    {errors.fatherResidenceCountry && (
                      <ErrorMessages errors={errors.fatherResidenceCountry} />
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="mb-6 text-left space-y-6">
              ...
              <div>
                ...
                {errors.dateOfMarriage && (
                  <ErrorMessages errors={errors.dateOfMarriage} />
                )}
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    />
                    {errors.marriageCity && (
                      <ErrorMessages errors={errors.marriageCity} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.marriageProvince && (
                      <ErrorMessages errors={errors.marriageProvince} />
                    )}
                  </div>
                  <div>
                    <input
                    ...
                    {errors.marriageCountry && (
                      <ErrorMessages errors={errors.marriageCountry} />
                    )}
                  </div>
                </div>
              </div>
          ...
          {currentPage === 5 && (
            <div className="mb-6 text-left space-y-6">
              ...
              {/* Type of Attendant */}
              <div
                className={`p-2 ${errors.attendantGroup ? 'input-error' : ''}`}
              >
                <label className="block w-full text-sm font-medium mb-1">
                  Type of Attendant
                </label>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      name="attendantPhysician"
                      checked={formData.page5.attendantPhysician}
                      onChange={(e) =>
                        handleCheckboxChange(e, `page${currentPage}`)
                      }
                    />
                    <span>Physician</span>
                  </label>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:space-x-2 mt-3">
                  ...
                  <div className="mt-2 md:mt-0 w-full">
                    ...
                    />
                    {errors.attendantOthersSpecify && (
                      <ErrorMessages errors={errors.attendantOthersSpecify} />
                    )}
                  </div>
                </div>
                {errors.attendantGroup && (
                  <ErrorMessages errors={errors.attendantGroup} />
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                />
                {errors.dateOfAttendance && (
                  <ErrorMessages errors={errors.dateOfAttendance} />
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                />
                {errors.attendantNameTitle && (
                  <ErrorMessages errors={errors.attendantNameTitle} />
                )}
              </div>
            </div>
          )}
            ...
            <div className="mb-6 text-left space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.birthTime && (
                    <ErrorMessages errors={errors.birthTime} />
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  />
                  {errors.birthDate && (
                    <ErrorMessages errors={errors.birthDate} />
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {errors.attendantName && (
                    <ErrorMessages errors={errors.attendantName} />
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.attendantTitle && (
                    <ErrorMessages errors={errors.attendantTitle} />
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                />
                {errors.attendantAddress && (
                  <ErrorMessages errors={errors.attendantAddress} />
                )}
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {errors.informantName && (
                      <ErrorMessages errors={errors.informantName} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    {errors.informantRelationship && (
                      <ErrorMessages errors={errors.informantRelationship} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.informantAddress && (
                      <ErrorMessages errors={errors.informantAddress} />
                    )}
                  </div>
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.informantDate && (
                    <ErrorMessages errors={errors.informantDate} />
                  )}
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.preparedName && (
                      <ErrorMessages errors={errors.preparedName} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.preparedTitle && (
                      <ErrorMessages errors={errors.preparedTitle} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.preparedDate && (
                      <ErrorMessages errors={errors.preparedDate} />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.receivedName && (
                      <ErrorMessages errors={errors.receivedName} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.receivedTitle && (
                      <ErrorMessages errors={errors.receivedTitle} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.receivedDate && (
                      <ErrorMessages errors={errors.receivedDate} />
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {errors.registrarName && (
                      <ErrorMessages errors={errors.registrarName} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.registrarTitle && (
                      <ErrorMessages errors={errors.registrarTitle} />
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    />
                    {errors.registrarDate && (
                      <ErrorMessages errors={errors.registrarDate} />
                    )}
                  </div>
                </div>
              </div>
          ...
          {currentPage === 9 && (
            <div className="mb-6 text-left space-y-2">
              ...
              <div>
                <InfoCard
                  title="TO BE FILLED-UP AT THE OFFICE OF THE CIVIL REGISTRAR"
                  message=""
                  isClosable={false}
                >
          ...
          {currentPage === 10 && (
            <div className="mb-6 text-left space-y-6">
              ...
              <p className="text-sm italic w-full">
                ...
                {formData.page10.childName ? (
                  <u className="font-semibold"> {formData.page10.childName} </u>
                ) : (
                  ' __________________ '
                )}{' '}
                born on{' '}
                {formData.page10.childBirthDate ? (
                  <u className="font-semibold">
                    {' '}
                    {formData.page10.childBirthDate}{' '}
                  </u>
                ...
                at{' '}
                {formData.page10.childBirthPlace ? (
                  <u className="font-semibold">
                    {' '}
                    {formData.page10.childBirthPlace}{' '}
                  </u>
              ...
              <div>
                ...
                />
                {errors.motherName && (
                  <ErrorMessages errors={errors.motherName} />
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.fatherName && (
                  <ErrorMessages errors={errors.fatherName} />
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.childName && (
                  <ErrorMessages errors={errors.childName} />
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {errors.childBirthPlace && (
                    <ErrorMessages errors={errors.childBirthPlace} />
                  )}
                </div>
              </div>
              ...
              <p className="text-sm italic">
                ...
                truthfulness of the foregoing statements and for purposes of
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="text-center">
                  <label className="block text-sm font-medium mb-2">
                    {AllCaps(formData.page10.motherName)}
                  </label>
                ...
                <div className="text-center">
                  <label className="block text-sm font-medium mb-2">
                    {AllCaps(formData.page10.fatherName)}
                  </label>
                  <div className="border-t border-gray-400 pt-2 text-gray-600">
                    Signature over printed name
                  </div>
          ...
          {currentPage === 11 && (
            <div className="mb-6 text-left space-y-6">
              ...
              {/* Jurat Text */}
              <p className="text-sm italic">
                <strong>SUBSCRIBED AND SWORN</strong> to before me this ______
                day of _______________ by __________________ and
                __________________, who exhibited to me (his/her) Community Tax
                Cert. No. __________________ issued on _______________ at
                ___________________.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.juratDay && (
                    <ErrorMessages errors={errors.juratDay} />
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.juratMonthYear && (
                    <ErrorMessages errors={errors.juratMonthYear} />
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.juratAffiant1 && (
                    <ErrorMessages errors={errors.juratAffiant1} />
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.juratAffiant2 && (
                    <ErrorMessages errors={errors.juratAffiant2} />
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                />
                {errors.ctcNumber && (
                  <ErrorMessages errors={errors.ctcNumber} />
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.ctcDateIssued && (
                    <ErrorMessages errors={errors.ctcDateIssued} />
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.ctcPlaceIssued && (
                    <ErrorMessages errors={errors.ctcPlaceIssued} />
                  )}
                </div>
              </div>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div>
                  ...
                  />
                  {errors.adminName && (
                    <ErrorMessages errors={errors.adminName} />
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.adminPosition && (
                    <ErrorMessages errors={errors.adminPosition} />
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.adminAddress && (
                    <ErrorMessages errors={errors.adminAddress} />
                  )}
                </div>
              </div>
            </div>
          ...
          {currentPage === 12 && (
            <div className="mb-6 text-left space-y-6">
              ...
              <p className="text-sm italic text-center">
                ...
                father, mother, guardian, or the person himself/herself if 18
                years old or over.)
              </p>

              <p className="text-sm italic">
                I _____________________________ , of legal age, single / married
                / divorced / widow / widower, with residence and postal address
                at ______________________________________________________ after
                having been duly sworn in accordance with law, do hereby depose
                and say:
              </p>
              ...
              <div>
                ...
                />
                {errors.affiantName && (
                  <ErrorMessages errors={errors.affiantName} />
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    <option value="">Select</option>
                    <option value={CivilStatus.SINGLE}>
                      {capitalizeFirst(CivilStatus.SINGLE)}
                    </option>
                    <option value={CivilStatus.MARRIED}>
                      {capitalizeFirst(CivilStatus.MARRIED)}
                    </option>
                    <option value={CivilStatus.DIVORCED}>
                      {capitalizeFirst(CivilStatus.DIVORCED)}
                    </option>
                    <option value={CivilStatus.WIDOW}>
                      {capitalizeFirst(CivilStatus.WIDOW)}
                    </option>
                  </select>
                  {errors.civilStatus && (
                    <ErrorMessages errors={errors.civilStatus} />
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <span className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                      ...
                      <div className="flex flex-col flex-1">
                        ...
                        />
                        {errors.selfPob && (
                          <ErrorMessages errors={errors.selfPob} />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                      ...
                      <div className="flex flex-col flex-1">
                        ...
                        />
                        {errors.selfDob && (
                          <ErrorMessages errors={errors.selfDob} />
                        )}
                      </div>
                    </div>
                  </span>
                  ...
                  <span className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                      ...
                      <div className="flex flex-col flex-1">
                        ...
                        />
                        {errors.childPob && (
                          <ErrorMessages errors={errors.childPob} />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                      ...
                      <div className="flex flex-col flex-1">
                        ...
                        />
                        {errors.childDob && (
                          <ErrorMessages errors={errors.childDob} />
                        )}
                      </div>
                    </div>
                  </span>
                ...
                <label className="flex flex-col sm:flex-row sm:items-center sm:space-x-2 w-full mb-2">
                  <div>
                    <input
                      ...
                      checked={
                        formData.page12.parentsStatus == MarriageStatus.MARRIED
                      }
                      onChange={(e) =>
                        handleCheckboxChange(e, `page${currentPage}`)
                      }
                  ...
                  <span className="flex-1 flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      />
                      {errors.marriageDate && (
                        <ErrorMessages errors={errors.marriageDate} />
                      )}
                    </div>
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      {errors.marriagePlace && (
                        <ErrorMessages errors={errors.marriagePlace} />
                      )}
                    </div>
                  </span>
                </label>
                ...
                <label className="flex flex-col sm:flex-row sm:items-center sm:space-x-2 w-full mb-2">
                  ...
                  <span className="flex-1 flex flex-col gap-2">
                    <span className="whitespace-wrap">
                      Not married but acknowledged/not acknowledged by father
                      whose name is
                    </span>
              ...
              <div>
                ...
                />
                {errors.reasonDelay && (
                  <ErrorMessages errors={errors.reasonDelay} />
                )}
              </div>
              ...
              <div>
                ...
                <div>
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.spouseApplicant && (
                    <ErrorMessages errors={errors.spouseApplicant} />
                  )}
                </div>
                <p className="text-sm font-medium mt-4">
                  (If the applicant is other than the document owner) That I am
                  married to:
                </p>
                <div>
                  <input
                  ...
                  />
                  {errors.spouseOwner && (
                    <ErrorMessages errors={errors.spouseOwner} />
                  )}
                </div>
              </div>
            </div>
          ...
          {currentPage === 13 && (
            <div className="mb-6 text-left space-y-6">
              ...
              <div className="">
                ...
                <div className="pt-6">
                  <p className="text-sm italic">
                    ...
                    ____ day of _____________ at __________________,
                    Philippines.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                />
                {errors.juratPlace && (
                  <ErrorMessages errors={errors.juratPlace} />
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  />
                  {errors.ctcIssuedOn && (
                    <ErrorMessages errors={errors.ctcIssuedOn} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  />
                  {errors.ctcIssuedAt && (
                    <ErrorMessages errors={errors.ctcIssuedAt} />
                  )}
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.adminOfficerName && (
                    <ErrorMessages errors={errors.adminOfficerName} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.adminOfficerPosition && (
                    <ErrorMessages errors={errors.adminOfficerPosition} />
                  )}
                </div>
                <div className="flex flex-col">
                  <label className="block text-sm font-medium mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, `page${currentPage}`)}
                  />
                  {errors.adminOfficerAddress && (
                    <ErrorMessages errors={errors.adminOfficerAddress} />
                  )}
                </div>
              </div>
            </div>
          ...
          {currentPage == 14 && (
            <div className="p-4 border rounded-lg bg-yellow-50 space-y-3 shadow-sm">
              ...
              <p className="text-sm text-gray-700 text-center font-medium">
                ⚠️ Please double-check that all the information you have
                provided is accurate and complete before proceeding.
              </p>
              ...
              <div className="flex flex-col items-center space-y-3">
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    name="confirmation"
                    checked={
                      formData[`page${currentPage}`]?.confirmation || false
                    }
                    onChange={(e) =>
                      handleCheckboxChange(e, `page${currentPage}`)
                    }
